    ...
    <div className="relative w-screen h-screen" style={{ background: "#003049" }}>
      ...
      >
        <div className="flex items-center gap-3">
          <Link href="/metryca/tours" className="text-white/40 hover:text-[#f67f00] transition-colors text-sm">
            ← Tours
          </Link>
          <span className="text-white/20">|</span>
          <span className="text-white/60 text-sm tracking-widest uppercase">Tour Sheraton</span>
        </div>
        <span className="text-[#f67f00]/60 text-xs tracking-[0.3em] uppercase">360°</span>
      </div>
