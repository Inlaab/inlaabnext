    ...
    <section className="relative min-h-screen overflow-hidden">
      ...
      >
        <div className="w-full px-4">
          <div
            id="navbar-container"
            className="backdrop-blur-md bg-white/10 rounded-2xl py-6 px-8 shadow-2xl max-w-5xl mx-auto transition-all duration-300 ease-in-out chat-navbar"
          >
            <div className="text-white">
              ...
              <div className="hidden md:flex items-center justify-between">
                <a
                  href="#about"
                  className="hover:text-inlaab-yellow transition-colors duration-300 font-light text-sm tracking-wide text-center w-1/5"
                >
                  About
                </a>
                <a
