      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-inlaab-cream max-w-5xl mx-auto leading-relaxed font-light">
            We specialize in two essential fronts: strategic business consulting and advanced technological development. Our Insight division focuses on business transformation and growth, while DevHub drives innovation with custom software and hardware solutions. Together, we provide a comprehensive strategy to drive your business towards success in the digital era.
          </p>
        </div>

        {/* Flip Cards Container */}
        <div id="flip-cards-container" className="relative grid md:grid-cols-2 gap-0 max-w-5xl mx-auto mb-12">
          {/* Flip Card 1 - Insight */}
          <div 
            ref={flipCard1Ref}
          ...
          >
            <div className="flip-card-inner">
              ...
              <div className="flip-card-front text-white flex flex-col justify-center items-center p-8 text-center">
                <h3 className="text-3xl font-bold mb-4 font-heading">Insight</h3>
                <p className="text-lg mb-6 font-medium">Expertise in Business Strategy</p>
              ...
              <div className="flip-card-back text-white flex flex-col justify-center items-center p-8 text-center">
                <h3 className="text-2xl font-bold mb-6 font-heading">Insight</h3>
                <p className="text-sm leading-relaxed font-light">
                  Discover how INLAAB&apos;s Insight can be your strategic ally, offering business consulting, digital transformation, and process optimization to take your company to the next level. Turn challenges into opportunities and accelerate your growth with customized and scalable solutions.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flip-card-inner">
              ...
              <div className="flip-card-front text-white flex flex-col justify-center items-center p-8 text-center">
                ...
                <p className="text-lg mb-6 font-medium">Advanced Technological Development</p>
                <div className="space-y-3 text-sm font-light">
                  <div className="flex items-center justify-center">
                  ...
                  <div className="flex items-center justify-center">
                    <span className="px-3 py-1">- INNOVATIVE AI PRODUCTS -</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flip-card-back text-white flex flex-col justify-center items-center p-8 text-center">
                ...
                <p className="text-sm leading-relaxed font-light">
                  At INLAAB&apos;s DevHub, we combine advanced engineering and custom software development to create technology that drives your vision. From artificial intelligence solutions to cross-platform applications, our expert team is ready to innovate and automate your operations.
                </p>
              </div>
            </div>
          </div>
